...
//            _metaData
    ...
    function payCryptoRent(
        ...
        require(rentPayment.paymentStatus == PaymentStatus.PENDING, "Payment is not pending");
...
//        string metadata
    ...
    event OpenProposalSubmitted(
        uint256 openProposalId,
        string cid
    );
